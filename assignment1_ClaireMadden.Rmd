...
hares_hist <- ggplot(data = hares_mf, aes(x = year))+
  ...
  labs(x = "Year of Observation",
       y = "Observation Count", 
       title = "Snowshoe Hare Monitoring Observations in the Bonanza Creek \nExperimental Forest Between 1998 - 2012")+
...
hare_table <- kable(hare_summary, align = "c", col.names = c("Year", "Count", "Average Weight", "Count", "Average Weight"), caption = "Table 1. Sumamry Statistics for Snowshoe Hare Monitoring at Bonanza Creek Experimental Forest Between 1998 - 2012.") %>% 
